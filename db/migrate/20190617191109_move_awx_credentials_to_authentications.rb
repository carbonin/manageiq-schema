class MoveAwxCredentialsToAuthentications < ActiveRecord::Migration[5.0]
  ...
  class Fernet256
    ...
    #
    # The verify bit will be described below, but the bluk of what is in the
    ...
    # it's C implementation directly, so if this looks a bit simpler, that is
    # because it is.
    #
    ...
    # This method is a smaller portional of the Fernet#decrypt method from the
    # cryptography python lib:
    #
